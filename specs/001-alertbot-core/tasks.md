...
- [X] T051 [P] [US2] Card @-mention rendering test: each oncall tier output renders to the correct Lark mention syntax (`<at user_id="…">name</at>` or role mention for fallback) in `tests/unit/services/test_cards_mention.py`
